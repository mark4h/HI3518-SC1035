...
void sensor_init()
{
	...
	sensor_write_register(0x3000, 0x1); // soft reset
	sensor_write_register(0x3003, 0x1);

	sensor_write_register(0x3400, 0x53); // bit[0] rnc_en, 1 enable, 0 disable
	// sensor_write_register(0x3400, 0x3);
	sensor_write_register(0x3416, 0xC0);
	sensor_write_register(0x3d08, 0x00);
	// sensor_write_register(0x5000, 0x00);
	sensor_write_register(0x5000, 0x09); // 0x9 = 0b1001
	                                     // bit[0] awb, 1 auto enable, 0 manual
					     // bit[3] awb_gain, 1 enable
					     // bit[4] var_en, 1 enable
					     // bit[7] lenc, 1 enable
	sensor_write_register(0x3e03, 0x00); // bit[0] aec, 0 auto enable, 1 manual
	                                     // bit[1] agc, 0 auto enable, 1 manual
	sensor_write_register(0x3928, 0x00); // use 8 channel black level compensation
	
        // ANA Regs
	sensor_write_register(0x3612, 0x00);
	sensor_write_register(0x3620, 0x44);
	sensor_write_register(0x3622, 0x2e);
	...
	sensor_write_register(0x3115, 0x0a);
	sensor_write_register(0x3332, 0x38);
	sensor_write_register(0x5054, 0x82);
	sensor_write_register(0x3907, 0x01);
	sensor_write_register(0x3908, 0xc0);
	sensor_write_register(0x3e0f, 0x14); // missing

	// this additional line is required
	sensor_write_register(0x3223, 0x22); // missing

 	// these following setting are for the configuration 1280x960 @ 30fps and 54MHz
 
       /*
 	sensor_write_register(0x3010, 0x21);
	sensor_write_register(0x3011, 0x86);
 	sensor_write_register(0x3004, 0x1f);
 	sensor_write_register(0x3010, 0x07);
 	sensor_write_register(0x3011, 0x46);
 	sensor_write_register(0x3004, 0x04);
 	sensor_write_register(0x320c, 0x07);
 	sensor_write_register(0x320d, 0x08);
 	sensor_write_register(0x320e, 0x03);
 	sensor_write_register(0x320f, 0xe8);
 	sensor_write_register(0x3210, 0x00);
 	sensor_write_register(0x3211, 0x62);
 	sensor_write_register(0x3212, 0x00);
 	sensor_write_register(0x3213, 0x08);
	...
	// these following setting are for the configuration 1280x720 @ ??fps and 54MHz
    ...
    // Test patterns
    //sensor_write_register(0x3781, 0x90);
    //sensor_write_register(0x503d, 0x80);

    // Mirror and flip the image left right
    // sensor_write_register(0x321d, 0x1);
    // sensor_write_register(0x321c, 0x1 << 6);
}

void sensor_init_sofia()
{
	int use_full_res = 0;
	...
	sensor_write_register(0x3e03, 0x3); // 0x00
	...
	sensor_write_register(0x3300, 0x33);
	sensor_write_register(0x3301, 0x38); // 0x61
	sensor_write_register(0x3302, 0x30);
	sensor_write_register(0x3303, 0x66); // 0x56
	sensor_write_register(0x3304, 0xa0);
	sensor_write_register(0x3305, 0x72);
	sensor_write_register(0x331e, 0x56);
	...
	sensor_write_register(0x3622, 0x26); // missing
	
	sensor_write_register(0x3907, 0x2); // 0x01
	sensor_write_register(0x3908, 0x0); // 0xc0
	
	sensor_write_register(0x3601, 0x18); // missing
	sensor_write_register(0x3315, 0x44); // missing
	sensor_write_register(0x3308, 0x40); // missing
	
	sensor_write_register(0x3223, 0x22); // missing

	sensor_write_register(0x3e0d, 0x50); // missing
	sensor_write_register(0x3101, 0x9b); // missing
	sensor_write_register(0x3114, 0x3); // missing
	sensor_write_register(0x3115, 0xd1); // repeated
	sensor_write_register(0x3211, 0x60); // repeated
	sensor_write_register(0x5780, 0xff); // missing
	sensor_write_register(0x5781, 0x7f); // missing
	sensor_write_register(0x5785, 0xff); // missing
	sensor_write_register(0x5000, 0x0); // repeated
	sensor_write_register(0x3631, 0x82); // repeated
	...
	else
	{
	    ...
	    sensor_write_register(0x3011, 0x46);
	    sensor_write_register(0x3004, 0x4);
	    sensor_write_register(0x3610, 0x2b); //missing
	    sensor_write_register(0x320c, 0x7);
	    sensor_write_register(0x320d, 0x8);
	    sensor_write_register(0x320e, 0x3);
	    sensor_write_register(0x320f, 0xe8);
	    ...
	    sensor_write_register(0x3330, 0xd); // missing
	    sensor_write_register(0x3320, 0x6); // missing
	    sensor_write_register(0x3321, 0xe8); // missing
	    sensor_write_register(0x3322, 0x1); // missing
	    sensor_write_register(0x3323, 0xc0); // missing
	    sensor_write_register(0x3600, 0x54); // missing
	}

	// sensor_write_register(0x331e, 0xe0);
	sensor_write_register(0x3e02, 0xf0);
	sensor_write_register(0x3e01, 0xff);
	sensor_write_register(0x3e00, 0x0f);
}

void sensor_init_i2c_capture()
{
